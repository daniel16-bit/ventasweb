                            ...
                            <tbody>
                                <?php foreach ($cities as $city): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="./modificar/modificar_ciudad.php?id=<?php echo $city['ID_Ciudad']; ?>" class="text-primary me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar">
                                                <i class="fas fa-edit fs-5"></i>
                                            </a>
                                            <a href="#" class="text-danger" data-href="controllers/eliminar_ciudad.php?id=<?php echo $city['ID_Ciudad']; ?>" data-bs-toggle="modal" data-bs-target="#confirmar-delete" data-bs-placement="top" title="Eliminar" data-bs-toggle="tooltip">
