<?php
include_once '../models/conexion.php'; // aquí se crea $conn con sqlsrv_connect()

if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    $id_departamento = (int) $_GET['id'];

    // Consulta con parámetro
    $sql = "SELECT * FROM colfar.DEPARTAMENTO WHERE ID_Departamento = ?";
    ...
    $departamento = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC);
} else {
    die("⚠️ ID de departamento no válido.");
}
?>
<!DOCTYPE html>
<html lang="es">
...
<body>
    <div class="container">
        ...
        <form action="../controllers/modificar_departamentos.php" method="POST">
            <input type="hidden" name="id" value="<?php echo htmlspecialchars($id_departamento); ?>" required>
            <div class="mb-3">
