...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $sql = "SELECT 
            ...
            FROM 
                colfar.VENDEDOR VE
            JOIN 
                colfar.USUARIO U ON VE.ID_Usuario = U.ID_Usuario
            JOIN 
                colfar.ZONA Z ON VE.ID_Zona = Z.ID_Zona
    ...
    if (!$vendedor) {
        die("⚠️ No se encontró el vendedor.");
    }
} else {
    die("⚠️ El parámetro 'id' es necesario y debe ser numérico.");
}
?>
<!DOCTYPE html>
<html lang="es">
