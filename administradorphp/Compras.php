    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <a href="Reportes/compras_pdf.php" class="btn btn-primary mb-3">Generar Reporte</a>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="miModalLabel">Datos de la Compra</h5>
                ...
                <div class="card mb-4">
                    <div class="card-header bg-primary text-white">
                        <i class="fas fa-table me-2"></i> Tabla compras
                    </div>
                    <div class="card-body">
                            ...
                            <?php foreach ($compras as $compra): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" 
                                           data-href="controllers/eliminar_compra.php?id=<?php echo $compra['ID_Compra']; ?>" 
...
<script>
    ...
    // Actualizar enlace de eliminar en el modal dinámicamente
